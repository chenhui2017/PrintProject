...
namespace PrintDAL
{
    ...
    public interface IDbHelper
    {
        ...
        /// <param name="param">参数化</param>
        /// <returns></returns>
        int ExecuteBySql(string sql, SqlParam[] param);
        ...
        /// <param name="param">参数化</param>
        /// <returns></returns>
        int ExecuteBySqls(List<string> listSql, object[] param);
        ...
        /// <returns></returns>
        DataTable GetQuery(string strSql);
        ...
        /// <returns></returns>
        //DataTable GetDataTable(bool isAll, string TargetTable);

        DataTable QueryDataTable(string TargetTable, bool isAll = false);
        ...
        DataTable GetProcData(string ProcName, SqlParameter[] param);

        int ExecuteProcData(string ProcName, SqlParameter[] param);
        ...
        /// </summary>
        /// <returns></returns>
        bool Submit_AddOrEdit(string tableName, string pkName, string pkVal, Hashtable ht, bool isEdit = true);
        /// <summary>
        /// 根据唯一ID获取Hashtable
        /// </summary>
        ...
        /// <returns></returns>
        int IsExist(string tableName, string pkName, string pkVal, string filter = "");
        /// <summary>
        /// 通过Hashtable插入数据
        /// </summary>
