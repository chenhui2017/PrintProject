...
namespace PrintProject
{
    ...
    public class JsonHelper
    {
        ...
        public static string DataTableToJson(DataTable dt, string dtName)
        {
            ...
            if (DataTableHelper.IsExistRows(dt) & dt.Rows.Count > 0)
            {
        ...
        //==============
        //== add by yxh
        public static string SerializeToJsonA(DataTable dt)
        {
        ...
        public static string ConventToJson<T>(List<T> list, int count)
        {
            ...
            //string _text = "{\"total\":" + 1 + ",\"rows\":[{\"RegisterID\":\"1111\",\"XMDH\":\"1211\",\"XMMC\":\"阿道夫\",\"PTYPE\":\"套餐\"}]}";
            strJson += "}";
        ...
        /// </summary>
        /// <returns></returns>
        public static string ConventToJson<T>(List<T> list)
        {
            JavaScriptSerializer serializer = new JavaScriptSerializer();
            string strJson = serializer.Serialize(list);
            strJson = strJson.Substring(1);
